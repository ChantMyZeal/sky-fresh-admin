  ...
  <div class="container top10">
    <h2 class="homeTitle">
      ...
      <input
        type="number"
        v-model="limit"
        @keyup.enter="changeLimit()"
      />
      {{limit == null ? "&nbsp;&nbsp;商品总数" : ""}}：{{this.topData.nameList ? this.topData.nameList.length : 0}}个
    </h2>
    <div class="charBox">
...
export default class extends Vue {
  ...
  initChart() {
    ...
    myChart.getDom().style.height = `${
      this.topData.nameList.length * 40 + 20
    }px`
    myChart.resize()
    var option: any
    option = {
      ...
      yAxis: {
        ...
        data: this.topData.nameList,
      },
      series: [
        {
          data: this.topData.numberList,
          type: 'bar',
          showBackground: true,
          backgroundStyle: {
            color: '#F3F4F7',
            ...
            normal: {
              ...
              color: new echarts.graphic.LinearGradient( // 渐变色
                ...
                [
                  ...
                  { offset: 0, color: '#88c5ff' },
                  { offset: 1, color: '#feb5c1' },
                ]
              ),
              label: {
                //内容样式
